FROM opensearchproject/opensearch:1.3.12
...
ARG EXPORTER_PLUGIN_URL="https://github.com/Aiven-Open/prometheus-exporter-plugin-for-opensearch/releases/download/1.3.12.0/prometheus-exporter-1.3.12.0.zip"
