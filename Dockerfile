FROM opensearchproject/opensearch:1.3.16
...
ARG EXPORTER_PLUGIN_URL="https://github.com/Aiven-Open/prometheus-exporter-plugin-for-opensearch/releases/download/1.3.16.0/prometheus-exporter-1.3.16.0.zip"
