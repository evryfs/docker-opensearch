FROM opensearchproject/opensearch:1.3.8
...
ARG EXPORTER_PLUGIN_URL="https://github.com/aiven/prometheus-exporter-plugin-for-opensearch/releases/download/1.3.8.0/prometheus-exporter-1.3.8.0.zip"
